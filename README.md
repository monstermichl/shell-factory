...
*To give you a jump start using regularely used commands, please refer to the [common commands collection (shell-factory-cocos)](https://github.com/monstermichl/shell-factory-cocos).*
